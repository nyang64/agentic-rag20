...
from scraper.llamaindex_agent import aquery_agent, astream_agent_events, create_sessions_table
...
async def lifespan(app: FastAPI):
    ...
    if db_url:
        try:
            ...
            print("Conversation memory: llamaindex_chat_sessions table ready")
        except Exception as e:
            print(f"Warning: could not create chat sessions table ({e}); running without memory")
    yield


app = FastAPI(title="Agentic RAG — LlamaIndex", lifespan=lifespan)
